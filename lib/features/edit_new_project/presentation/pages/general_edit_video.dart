...
class _GeneralEditVideosState extends State<GeneralEditVideos> {
  ...
  void initState() {
    ...
    int maxDuration =
        mediaProcessCubit!.controller.videoDuration.inSeconds.toInt();
    print(maxDuration);
  }

  @override
  void dispose() async {
    mediaProcessCubit?.exportingProgress.dispose();
    mediaProcessCubit?.isExporting.dispose();
    mediaProcessCubit?.controller.dispose();
