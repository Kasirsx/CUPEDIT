...
//  static const primaryColor = Color.fromRGBO(26, 51, 76, 1);
  ...
  //static const primaryColor = Color.fromARGB(248, 55, 88, 15);
  static const mainGrayColor = Color(0xFFF4F6F8);

  //static const mainGrayColor = Color(0xFFA8A8A9);
...
//  MaterialColor(0xFF4297C8, primarySwatch);
  ...
  static LinearGradient homwPageCardGradinet = const LinearGradient(
    colors: [
      Color(0xffACE2E1),
      Color(0xff41C9E2),
      Color(0xff41C9E2),
