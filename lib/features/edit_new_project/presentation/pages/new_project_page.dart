...
class _NewProjectPageState extends State<NewProjectPage> {
  ...
  List<AssetPathEntity> albumListVideo = [];
  List<AssetEntity> assetListVideo = [];
  List<AssetEntity> selectedAssetListVideo = [];

  AssetPathEntity? selectedAlbumImage;
  List<AssetPathEntity> albumListImage = [];
  List<AssetEntity> assetListImage = [];
  List<AssetEntity> selectedAssetListImage = [];
